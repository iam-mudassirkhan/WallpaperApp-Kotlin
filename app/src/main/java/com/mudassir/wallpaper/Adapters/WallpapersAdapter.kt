...
class WallpapersAdapter(val context: Context, val wallpapersList: List<Dir>, val onWallpaperClick : WallpaperOnClickListener)
   ...
   return (WallpapersViewHolder(binding))
    ...
    override fun onBindViewHolder(holder: WallpapersViewHolder, position: Int) {
        ...
        Glide.with(context)
            .load("http://199.231.185.126/project%231_wallpapers/City/" + myWallpapersList.file)
        ...
        holder.itemView.setOnClickListener {
            onWallpaperClick.onWallpaperClick("http://199.231.185.126/project%231_wallpapers/City/" + myWallpapersList.file)
        }

       /* holder.itemView.setOnLongClickListener {

        onWallpaperClick.onWallpaperLongClick(myWallpapersList)
            true
        }*/
