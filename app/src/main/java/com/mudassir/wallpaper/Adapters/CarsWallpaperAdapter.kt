...
class CarsWallpaperAdapter(val context: Context, val wallpapersList: List<Dir>, val onWallpaperClick : WallpaperOnClickListener)
    : RecyclerView.Adapter<CarsWallpaperAdapter.WallpapersViewHolder> () {
    ...
    override fun onBindViewHolder(holder: WallpapersViewHolder, position: Int) {
        ...
        Glide.with(context)
            .load("http://199.231.185.126/project%231_wallpapers/Cars/" + myWallpapersList.file)
        ...
        holder.itemView.setOnClickListener {
            onWallpaperClick.onWallpaperClick("http://199.231.185.126/project%231_wallpapers/Cars/" + myWallpapersList.file)
        }
