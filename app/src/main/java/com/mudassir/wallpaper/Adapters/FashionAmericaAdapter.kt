...
class FashionAmericaAdapter(val context: Context, val wallpapersList: List<Dir>, val onWallpaperClick : WallpaperOnClickListener)
    : RecyclerView.Adapter<FashionAmericaAdapter.WallpapersViewHolder> () {
    ...
    override fun onBindViewHolder(holder: WallpapersViewHolder, position: Int) {
        ...
        Glide.with(context)
            .load("http://199.231.185.126/project%231_wallpapers/Fashion%20(America)/" + myWallpapersList.file)
        ...
        holder.itemView.setOnClickListener {
            onWallpaperClick.onWallpaperClick("http://199.231.185.126/project%231_wallpapers/Fashion%20(America)/" + myWallpapersList.file)
        }
