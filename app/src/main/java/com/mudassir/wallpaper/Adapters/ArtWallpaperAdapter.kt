...
class ArtWallpaperAdapter(val context: Context, val wallpapersList: List<Dir>, val onWallpaperClick : WallpaperOnClickListener)
    : RecyclerView.Adapter<ArtWallpaperAdapter.WallpapersViewHolder> () {
    ...
    override fun onBindViewHolder(holder: WallpapersViewHolder, position: Int) {
        ...
        Glide.with(context)
            .load("http://199.231.185.126/project%231_wallpapers/Art/" + myWallpapersList.file)
        ...
        holder.itemView.setOnClickListener {
            onWallpaperClick.onWallpaperClick("http://199.231.185.126/project%231_wallpapers/Art/" + myWallpapersList.file)
        }
