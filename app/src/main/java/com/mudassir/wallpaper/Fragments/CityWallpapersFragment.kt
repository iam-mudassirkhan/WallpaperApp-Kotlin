...
import com.mudassir.wallpaper.databinding.FragmentCityWallpapersBinding
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response


class CityWallpapersFragment : Fragment(), WallpaperOnClickListener {
private lateinit var binding: FragmentCityWallpapersBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCityWallpapersBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ApiClientWithOutMVVM().getClient()?.getWallpapers()?.enqueue( object : Callback<getWallpapers>{
    ...
    fun setUpRecyclerView(wallpaperList: ArrayList<com.mudassir.wallpaper.Models.Dir>) {
        binding?.cityWallpaperRV?.layoutManager = GridLayoutManager(requireContext(), 3)
        binding?.cityWallpaperRV?.adapter = WallpapersAdapter(requireContext(), wallpaperList, this)
    }
